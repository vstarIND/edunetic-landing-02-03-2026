...
export const ContactPage = () => {
  return (
    <div className="bg-zinc-950 pt-24 md:pt-32">
      <section id="contact" className="py-16 md:py-24">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 md:gap-16">
            ...
            >
              <h2 className="text-cyan-primary font-display font-bold uppercase tracking-widest text-xs md:text-sm mb-4">Get In Touch</h2>
              <h3 className="text-3xl md:text-5xl font-display font-bold mb-6 md:mb-8">Let's Build Future-Ready Schools Together</h3>
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                >
                  <div className="w-10 h-10 md:w-12 md:h-12 glass rounded-full flex items-center justify-center text-cyan-primary group-hover:bg-cyan-primary group-hover:text-black transition-all">
                    <Mail size={20} />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="text-[10px] md:text-xs text-zinc-500 uppercase tracking-wider">Email Us</div>
                    <div className="text-base md:text-lg font-medium group-hover:text-cyan-primary transition-colors truncate">contactus@eduneticindia.in</div>
                  </div>
                </a>
                <a 
                ...
                >
                  ...
                  <div>
                    <div className="text-[10px] md:text-xs text-zinc-500 uppercase tracking-wider">WhatsApp Us</div>
                    <div className="text-base md:text-lg font-medium group-hover:text-cyan-primary transition-colors">+91 6394 397 986</div>
                  </div>
                </a>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8 }}
              className="glass p-6 md:p-12 rounded-[2rem]"
            >
