...
export const EcosystemSection = () => {
  ...
  return (
    <section id="ecosystem" className="min-h-screen py-24 md:py-32 bg-zinc-950 relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-cyan-primary/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-blue-600/5 rounded-full blur-[120px]" />
      </div>

      <div className="container mx-auto px-6 relative z-10 mt-12 md:mt-0">
        {/* Header Section */}
        <div className="max-w-5xl mr-auto mb-16 md:mb-32 text-left">
          <motion.div
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-display font-black text-white uppercase tracking-tighter leading-[0.9] text-left">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-16 md:mb-32">
          {features.map((f, i) => (
            <motion.div
              ...
              className="glass p-6 md:p-8 rounded-3xl border-white/5 hover:border-cyan-primary/20 transition-all group"
            >
        ...
        <div className="space-y-12 md:space-y-16">
          <div className="text-center">
            <h3 className="text-3xl md:text-4xl font-display font-black text-white uppercase tracking-widest mb-4">Core Brand Products</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
            {products.map((product, i) => (
              ...
              >
                <div className="relative aspect-[16/10] rounded-[2rem] md:rounded-[3rem] overflow-hidden mb-6 md:mb-8 border border-white/5 group-hover:border-cyan-primary/40 transition-all duration-700 shadow-2xl bg-zinc-900/50">
                  <img 
                    src={product.image} 
                    alt={product.name} 
                    className="w-full h-full object-contain p-8 md:p-12 group-hover:scale-105 transition-transform duration-1000 blur-[2px] group-hover:blur-sm"
                    referrerPolicy="no-referrer"
                  />
                  <div className="absolute inset-0 bg-zinc-950/40 backdrop-blur-[1px] flex items-center justify-center">
                    <div className="px-4 md:px-6 py-2 rounded-full bg-cyan-primary/10 border border-cyan-primary/30 backdrop-blur-md">
                      <span className="text-cyan-primary font-black uppercase tracking-[0.2em] md:tracking-[0.3em] text-[10px] md:text-xs">Coming Soon</span>
                    </div>
                  </div>
                  
                  <div className="absolute top-6 left-6 md:top-8 md:left-8">
                    <div className="px-3 md:px-4 py-1 md:py-1.5 rounded-full bg-black/50 backdrop-blur-md border border-white/10 text-[8px] md:text-[10px] font-black uppercase tracking-widest text-cyan-primary">
                      {product.tag}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 md:space-y-6 px-4 md:px-6">
                  <h4 className="text-3xl md:text-4xl font-display font-black text-white uppercase tracking-tight group-hover:text-cyan-primary transition-colors duration-500">
                    {product.name}
                  </h4>
